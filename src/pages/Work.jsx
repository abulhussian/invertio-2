...
const Work = () => {
  ...
  const [activeFilter, setActiveFilter] = useState(searchParams.get("industry") || "All")
    ...
    <div className="pt-16 lg:pt-20">
        ...
        <div className="text-center max-w-4xl mx-auto">
          <MotionSlideUp>
            ...
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-gray-900 dark:text-white mb-6">
              Our Work Speaks
              <span className="gradient-text block">For Itself</span>
            </h1>
            <p className="text-xl text-gray-600 dark:text-gray-300 mb-8 leading-relaxed">
              Discover how we've helped organizations across industries transform their operations, drive innovation,
      ...
      {featuredStudies.length > 0 && (
        <Section className="bg-gray-50 dark:bg-gray-800/50">
          <MotionSlideUp className="mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">Featured Case Studies</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300">
              Our most impactful projects that showcase innovation and exceptional results.
            </p>
          </MotionSlideUp>

          <AnimatePresence mode="wait">
            <MotionStagger className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8" staggerDelay={0.1}>
      ...
      <Section className="bg-white dark:bg-gray-900">
        {regularStudies.length > 0 && (
          <>
            <MotionSlideUp className="mb-12">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-4">All Case Studies</h2>
              <p className="text-xl text-gray-600 dark:text-gray-300">
                Comprehensive portfolio of successful projects across various industries.
              </p>
            </MotionSlideUp>
        ...
        {filteredStudies.length === 0 && (
          <MotionFadeIn className="text-center py-16">
            ...
            <h3 className="text-2xl font-semibold text-gray-900 dark:text-white mb-4">No case studies found</h3>
